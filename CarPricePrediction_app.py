...
model = joblib.load(r"D:\Courses\Guvi AI_ML_DS\7. Capstone\P3_Used_Car_Price_Prediction\car_price_prediction_model.pkl")
label_encoders = joblib.load(r"D:\Courses\Guvi AI_ML_DS\7. Capstone\P3_Used_Car_Price_Prediction\label_encoders.pkl")
scalers = joblib.load(r"D:\Courses\Guvi AI_ML_DS\7. Capstone\P3_Used_Car_Price_Prediction\scalers.pkl")

# Load dataset for filtering and identifying similar data
data = pd.read_csv(r"D:\Courses\Guvi AI_ML_DS\7. Capstone\P3_Used_Car_Price_Prediction\car_dekho_cleaned_dataset_Raw.csv")
...
# Title of the app
st.markdown("<h1 style='text-align: center; color: crimson;'>Car Price Prediction</h1>", unsafe_allow_html=True)

# Sidebar for user inputs
st.sidebar.header('Choose Features')

# Set background colors
input_background_color  = "#EFC3CA"    
result_background_color = "#eab676"       
...
selected_oem = visual_selectbox('1. Make', data['oem'].unique())
...
modelYear = st.sidebar.number_input('8. Manufacturing Year', min_value=1980, max_value=2024, value=2015)

ownerNo = st.sidebar.number_input('9. Number of Owners', min_value=0, max_value=10, value=1)

km = st.sidebar.number_input('10. KMs Driven', min_value=0, max_value=500000, value=10000)
